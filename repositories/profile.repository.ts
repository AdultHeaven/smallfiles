...
export function mapPlanDetails(p: any): Plan {
  ...
  return {
    ...
    storage_limit: typeof p.storage_bytes === 'number' ? p.storage_bytes : (typeof p.storage_limit === 'number' ? p.storage_limit : Number(p.storage_bytes || p.storage_limit || planDefault.storage_limit || 1073741824)),
    max_file_size: typeof p.max_file_size_bytes === 'number' ? p.max_file_size_bytes : (typeof p.max_file_size === 'number' ? p.max_file_size : Number(p.max_file_size_bytes || p.max_file_size || planDefault.max_file_size || 26214400)),
    ...
    retention_days: p.retention_days !== undefined ? p.retention_days : (planDefault.retention_days ?? 90),
